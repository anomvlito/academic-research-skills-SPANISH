...
- **Primary entry point**: `articulo-academico/agentes/agente_admision` Step 10 (optional)
- **Pipeline carry**: `pipeline-academico` Pasaporte de Materiales carries the Style Profile across all stages
- **Consumers**: `articulo-academico/agentes/agente_redactor_borrador`, `investigacion-profunda/agentes/agente_compilador_informes`
...
Combine the 6 dimensions into a **Style Profile** artifact (see `shared/Traspaso_schemas.md` Schema 10).
