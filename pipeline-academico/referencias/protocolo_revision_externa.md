...
| Aspect | Internal Review (Etapa 3 simulation) | External Review (real journal) |
|--------|-------------------------------------|-------------------------------|
...
```
Etapa 3' behavior adjustments in external review mode:
...
2. New citation verification:
   - New references added during revision enter Etapa 4.5 integrity verification
...
1. **AI verification does not equal human reviewer satisfaction**: Etapa 3' can confirm revisions are "complete and consistent," but cannot predict whether human reviewers will accept your responses. Reviewers may have unstated expectations, school-of-thought preferences, or methodological insistence
