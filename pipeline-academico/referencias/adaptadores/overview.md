...
**Applies to**: any adapter that produces a Pasaporte de Materiales `literature_corpus[]` field
...
- [`shared/Traspaso_schemas.md`](../../../shared/Traspaso_schemas.md) Schema 9: the `literature_corpus[]` field lives inside the Pasaporte de Materiales.
- [`pipeline-academico/referencias/passport_as_reset_boundary.md`](../passport_as_reset_boundary.md): `literature_corpus[]` is consumed across reset boundaries like any other passport field.
