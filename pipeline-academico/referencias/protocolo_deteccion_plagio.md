...
Este documento defines the complete execution protocol for `agente_verificacion_integridad`'s Phase D (originality verification), including paragraph-level comparison, self-plagiarism check, AI-generated text characteristic detection, severity grading, and tool limitation disclaimers.
