...
Este documento defines the complete review standards for statistical reporting in quantitative research. `agente_revisor_metodologia` uses this document as the primary reference in Step 4a (Statistical Reporting Adequacy).
...
### 5.1 Recommended Methods by Pregunta de Investigación Type

| Pregunta de Investigación Type | Recommended Method | Description |
|-----------------------|-------------------|-------------|
...
`agente_revisor_metodologia` uses the following standards to assess statistical reporting completeness:
...
```
Step 1: Confirm Pregunta de Investigación -> analysis method correspondence is reasonable (Section 5)
