...
**Status**: v3.2
**Parent skill**: `articulo-academico-reviewer`
...
2. **Domain specification**: the user's target field, used to seed `agente_analista_campo`. Calibration for "machine learning venues" is not valid for "qualitative education research" — error profiles are domain-specific.
...
- ARS `articulo-academico-reviewer/referencias/quality_rubrics.md` — scoring rubric definitions.
