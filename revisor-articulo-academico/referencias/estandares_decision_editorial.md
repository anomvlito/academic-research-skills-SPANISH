...
Este documento defines the explicit criteria for Accept / Minor Revision / Major Revision / Reject decisions, for use by `agente_editor_jefe` and `agente_sintetizador_editorial`.
