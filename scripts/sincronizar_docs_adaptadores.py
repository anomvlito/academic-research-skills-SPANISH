#!/usr/bin/env python3
"""sync_adapter_docs: keep pipeline-academico/referencias/adapters/overview.md
...
DEFAULT_TARGET = REPO_ROOT / "pipeline-academico/referencias/adapters/overview.md"
