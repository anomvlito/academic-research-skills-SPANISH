...
- investigacion-profunda/agentes/agente_mentor_socratico.md §"Optional Reading Probe Layer"
- investigacion-profunda/referencias/socratic_mode_protocolo.md §"Reading Probe"
- investigacion-profunda/HABILIDAD.md §"Opt-in Reading Probe (v3.5.1)"
- pipeline-academico/referencias/process_summary_protocolo.md §"Reading Probe Outcomes"
...
MENTOR_AGENT = REPO_ROOT / "investigacion-profunda" / "agents" / "agente_mentor_socratico.md"
SOCRATIC_PROTOCOL = REPO_ROOT / "investigacion-profunda" / "references" / "socratic_mode_protocolo.md"
DEEP_RESEARCH_SKILL = REPO_ROOT / "investigacion-profunda" / "HABILIDAD.md"
README_EN = REPO_ROOT / "README.md"
README_ZH = REPO_ROOT / "README.zh-TW.md"
PIPELINE_PROCESS_SUMMARY = REPO_ROOT / "pipeline-academico" / "references" / "process_summary_protocolo.md"
