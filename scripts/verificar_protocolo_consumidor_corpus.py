...
REF_DOC_PATH = REPO_ROOT / "pipeline-academico" / "references" / "literature_corpus_consumers.md"
...
REF_DOC_BACKPOINTER = "pipeline-academico/referencias/literature_corpus_consumers.md"
...
# basename entries.
_BIBLIO_ENTRY = ("agente_bibliografia", "investigacion-profunda/agentes/agente_bibliografia.md")
_STRAT_ENTRY = (
    "agente_estratega_literatura",
    "articulo-academico/agentes/agente_estratega_literatura.md",
)
...
def check_l8() -> list[str]:
    ...
    # agente_bibliografia row pointing at a different path and have the
    ...
    if entry_set == PR_A_TUPLES:
        ...
        if DEFERRED_CAVEAT not in text:
            failures.append(
                ...
                f"agente_estratega_literatura ships in PR-B"
            )
    else:  # PR_B_TUPLES
