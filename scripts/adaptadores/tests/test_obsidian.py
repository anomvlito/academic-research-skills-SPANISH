...
VAULT = REPO_ROOT / "scripts/adapters/ejemplos/obsidian/input_fixture/vault"
EXPECTED_PASSPORT = REPO_ROOT / "scripts/adapters/ejemplos/obsidian/expected_passport.yaml"
EXPECTED_REJECTION = REPO_ROOT / "scripts/adapters/ejemplos/obsidian/expected_rejection_log.yaml"
