...
FIXTURE_INPUT = REPO_ROOT / "scripts/adapters/ejemplos/zotero/input_fixture/export.json"
EXPECTED_PASSPORT = REPO_ROOT / "scripts/adapters/ejemplos/zotero/expected_passport.yaml"
EXPECTED_REJECTION = REPO_ROOT / "scripts/adapters/ejemplos/zotero/expected_rejection_log.yaml"
