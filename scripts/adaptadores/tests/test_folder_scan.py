...
FIXTURE_DIR = REPO_ROOT / "scripts/adapters/ejemplos/folder_scan/input_fixture"
EXPECTED_PASSPORT = REPO_ROOT / "scripts/adapters/ejemplos/folder_scan/expected_passport.yaml"
EXPECTED_REJECTION = REPO_ROOT / "scripts/adapters/ejemplos/folder_scan/expected_rejection_log.yaml"
