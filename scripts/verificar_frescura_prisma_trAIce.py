#!/usr/bin/env python3
"""Warn when shared/prisma_trAIce_protocolo.md is older than 180 days.
...
Default path: shared/prisma_trAIce_protocolo.md (relative to repo root).
"""
...
DEFAULT_PATH = Path(__file__).resolve().parent.parent / "shared" / "prisma_trAIce_protocolo.md"
...
def main() -> int:
    ...
    if age_days > STALE_THRESHOLD_DAYS:
        print(
            f"WARNING: prisma_trAIce_protocolo.md snapshot is {age_days} days old "
