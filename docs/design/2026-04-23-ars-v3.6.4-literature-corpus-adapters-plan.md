...
- Create: `scripts/adapters/examples/folder_scan/input_fixture/Chinese filename_2024.pdf` (empty file — will be rejected: unicode)
...
touch "scripts/adapters/examples/folder_scan/input_fixture/Chinese filename_2024.pdf"
...
Material Passport   `literature_corpus[]`  **user-written adapter**  not ARS itself v3.6.4 includes three reference adapters `scripts/adapters/folder_scan.py` `scripts/adapters/zotero.py` `scripts/adapters/obsidian.py` Execution and instructions for user-written adapters see [`scripts/adapters/README.md`](../scripts/adapters/README.md) 
