...
2. Is your Pregunta de Investigación finalized? Can you state it clearly in one sentence?
3. Have you conducted a systematic literature search?

**User**:
I previously ran a round with investigacion-profunda. I obtained an Annotated Bibliography (about 30 articles), a Synthesis Report, and a set of INSIGHT Collections. My Pregunta de Investigación is roughly: "How does blended learning affect the academic performance of university students in Taiwan?" But I think it might be too broad.
...
You said "How does blended learning affect academic performance" — but that's more of a Pregunta de Investigación, not an argument. An argument is the answer you expect (or have already found).
...
3. **Pregunta de Investigación**: What is your RQ? (One sentence)
...
Suggested structure: Hook (policy data, 1 paragraph) → Background (blended learning definition + trends, 2 paragraphs) → Gap (three gaps, 1 paragraph) → Purpose & PI (1 paragraph)
...
→ Or send to `articulo-academico-reviewer` to review the feasibility of the Chapter Plan
```
