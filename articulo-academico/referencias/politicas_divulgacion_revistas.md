...
This file is consumed by `disclosure_mode_protocolo.md`. The mode looks up the venue by name, reads the structured fields below, and generates a tailored disclosure. Do NOT use this file as a standalone template — use disclosure mode.
