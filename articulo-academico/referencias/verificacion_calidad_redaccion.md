...
Reference this checklist during the self-review step of drafting (agente_redactor_borrador Step 2.7, agente_compilador_informes final check).
...
Apply rules **while writing each section** in the self-review sub-step (Step 2.7 in agente_redactor_borrador). This catches issues before they propagate.

### During Final Review (Fallback)
If not applied during drafting, run a full-paper sweep before Traspaso to agente_cumplimiento_citas.
