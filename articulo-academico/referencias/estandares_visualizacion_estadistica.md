...
Reference guide for the `agente_visualizacion`. Covers APA 7.0 figure guidelines, accessible color palettes, chart type selection, common pitfalls, and code templates.
