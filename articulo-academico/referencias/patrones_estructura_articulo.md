...
Used by `agente_arquitecto_estructura` and `agente_admision` to select the appropriate paper structure.
...
3. Introduction
   ...
   3.3 Research Gap
   3.4 Purpose and Pregunta de Investigacións
...
3. Introduction
   ...
   3.3 Pregunta de Investigacións
...
3. Introduction
   ...
   3.2 Pregunta de Investigación(s)
4. Related Work
