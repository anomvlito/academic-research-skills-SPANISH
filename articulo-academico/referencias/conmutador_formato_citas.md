...
Quick-reference for switching between 5 citation formats. Used by `agente_cumplimiento_citas` and `agente_formateador`.
...
For complete specifications, see `apa7_chinese_citation_guia.md`. Below is a quick reference.
