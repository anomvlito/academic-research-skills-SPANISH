...
- **Revision mode** (`revision` in HABILIDAD.md): when you have a draft and structured reviewer feedback
- **Revision Coach mode** (`revision-coach` in HABILIDAD.md): when you have unstructured reviewer comments that need parsing first
