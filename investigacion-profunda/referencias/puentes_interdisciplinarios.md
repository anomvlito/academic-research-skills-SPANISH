...
## Propósito
Reference for identifying connections across academic disciplines. Used by the agente_sintesis and research_architect_agent to enrich analysis with cross-disciplinary perspectives.
...
The same real-world problem, redefined from different disciplinary perspectives, produces entirely different Pregunta de Investigacións, method choices, and solutions.
