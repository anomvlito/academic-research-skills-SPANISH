...
See `agents/agente_riesgo_sesgo.md` and `agents/agente_meta_analisis.md` for detailed agent definitions.
...
=== Phase 1: SCOPING (Generates Protocol, not just RQ) ===
     ...
     |   - Protocol follows PRISMA-P 2015 (templates/prisma_protocol_plantilla.md)
     ...
     |
     +-> [devils_advocate_agent] -- punto de control 1
...
=== Phase 2: INVESTIGATION (PRISMA-Compliant Search + RoB) ===
     |
     |-> [agente_bibliografia] -> PRISMA Flow Diagram + Source Corpus
     ...
     |
     +-> [agente_riesgo_sesgo] -> RoB Assessment
...
=== Phase 3: ANALYSIS (Meta-Analysis or Narrative Synthesis) ===
     |
     |-> [agente_meta_analisis] -> Quantitative or Narrative Synthesis
     ...
     |
     |-> [agente_sintesis] -> Qualitative Themes + Gap Analysis
     |   - Thematic synthesis across studies
     |   - Integration with quantitative findings
     |
     +-> [devils_advocate_agent] -- punto de control 2
...
=== Phase 4: COMPOSITION ===
     |
     +-> [agente_compilador_informes] -> PRISMA 2020 Report
         - Uses templates/prisma_report_plantilla.md
...
=== Phase 5: REVIEW (Parallel) ===
     ...
     +-> [devils_advocate_agent] -- punto de control 3
     |
=== Phase 6: REVISION ===
     |
     +-> [agente_compilador_informes] -> Final PRISMA Report
```

## punto de control Rules

1. All standard punto de control rules apply (see HABILIDAD.md punto de control Rules)
