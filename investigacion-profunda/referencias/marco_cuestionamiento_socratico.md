...
## Academic Pregunta de Investigación Banks

### Pregunta de Investigación Clarification

1. Are you asking a "whether" question, a "how much" question, or a "why" question?
2. Can you state your Pregunta de Investigación in a single sentence? If it takes more than one sentence, it may need splitting.
...
Mentor: "If a university that completely didn't adopt online learning had better student grades and satisfaction than those that did, how would you explain that? Would this change your Pregunta de Investigación?"
```
...
| Design Principle | Mentor Socrático | ai-study-learn-engine |
|---------|-----------------|----------------------|
