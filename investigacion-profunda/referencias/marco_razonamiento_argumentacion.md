...
| Agent | Primary Use |
|-------|------------|
| `agente_sintesis` | Toulmin analysis of synthesized arguments; IBE for competing explanations |
...
| `agente_mentor_socratico` | Guide users through Toulmin decomposition of their own arguments |
