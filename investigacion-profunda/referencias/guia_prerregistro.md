...
| 3 | **Pregunta de Investigacións** | Main Pregunta de Investigacións (clear, specific) |
...
Pregunta de Investigación: What factors influence university student dropout decisions
                   in Taiwan?
...
| **Review** | Does not undergo peer review | Etapa 1 peer review (research design) |
| **Acceptance timing** | Paper submitted only after completion | Receives "In-Principle Acceptance" (IPA) after passing Etapa 1 |
...
└── Interpretation plan for predicted results
         ↓
Etapa 1 Review (research design quality)
├── Accept (In-Principle Acceptance, IPA)
├── Revise and resubmit
└── Reject
         ↓
Etapa 2: Conduct research, write results
├── Strictly follow the Etapa 1 plan
...
└── Deviations disclosed and explained
         ↓
Etapa 2 Review (execution quality)
├── Was the Etapa 1 plan faithfully executed?
...
3. **Fill in the 21-item checklist**: Use the `templates/preregistration_plantilla.md` template
