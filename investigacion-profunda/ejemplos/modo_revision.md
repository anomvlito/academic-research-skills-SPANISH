...
This example demonstrates the complete workflow of `review` mode. The user provides a previously written policy recommendation summary, and investigacion-profunda activates three review agents for multi-dimensional review.
...
|--------|----------|------|
| 1 | Delete or substantially revise the "reduce by 30% within five years" estimate | editor + Abogado del Diablo |
| 2 | Add source citations to all data, correct inaccurate figures | editor |
| 3 | Analyze why existing cross-institutional course-taking mechanisms failed, argue the incremental value of the new proposal | Abogado del Diablo |
...
| 7 | Distinguish between "transformable" and "should exit" school types | Abogado del Diablo |
