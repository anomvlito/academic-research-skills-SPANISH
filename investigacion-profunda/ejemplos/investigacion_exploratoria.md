...
- Minor: PI is broad — consider whether "emerging" limits to recent literature only
...
4. Recommendation #3 hedged: "should consider piloting" (Observation, Abogado del Diablo)
