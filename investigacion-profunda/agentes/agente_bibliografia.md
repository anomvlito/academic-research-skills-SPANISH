...
|-----------|---------|---------|
| Relevance | Directly addresses PI | Tangential or unrelated |
...
Reference: `references/semantic_scholar_api_protocolo.md`
...
When the input Pasaporte de Materiales carries a non-empty `literature_corpus[]`, this agent enters the **corpus-first, search-fills-gap** flow. The flow has five steps and four Iron Rules; the PRE-SCREENED block makes corpus utilisation reproducible.
