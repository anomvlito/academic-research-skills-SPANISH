...
- [ ] Studies address sufficiently similar Pregunta de Investigacións (PICOS alignment)
...
### agente_sintesis
- When meta-analysis is feasible: agente_meta_analisis handles quantitative synthesis; agente_sintesis handles qualitative themes and interpretation
- When meta-analysis is not feasible: agente_sintesis takes the lead on narrative synthesis using the framework provided by agente_meta_analisis
